...
import { addQuote } from '../Features/QuotesSlice'
...
const QuoteAdd = () => {
    ...
    const handleAddQuote = (event) => {
        if (qId === '' || qName === '' || createdAt === '' || amount === '' || customerName === '') {
            ...
            dispatch(addQuote({ qId, qName, status, createdAt, amount, customerName }))
            navigate('/quotes')
        }
    }
    ...
    return (
        <div>
            <h2 className='text-2xl font-semibold text-[#2C7EC6] mb-6'>Quote Add</h2>
