...
const QuoteDetails = () => {
    const { quoteDetails } = useSelector((store) => store.quotes)
    return (
        <div>
            <h2 className='text-2xl font-semibold text-[#2C7EC6] mb-6'>Quote Details</h2>
            <div className="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
                ...
                <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                    ...
                    <div className="mt-2 sm:col-span-2 sm:mt-0">
                        <input
                            disabled
                            value={quoteDetails[0].createdAt}
                            id="createdAt"
                            name="createdAt"
                            type="text"
                ...
                <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                    ...
                    <div className="mt-2 sm:col-span-2 sm:mt-0">
                        <input
                            disabled
                            value={quoteDetails[0].customerName}
                            id="cusName"
                            name="cusName"
                            type="text"
